    ...
    <div class="col-lg-7">
        <div class="container mt-5 pt-5 pb-5 ">
            <main class="form-input">
                <form action="/list_ird/input" method="post">
                    @csrf
                    <h1 class="h3 mb-3 fw-normal text-center">Input IRD</h1>
                    <div class="form-floating">
                        <input type="text" name="sn"
                            class="form-control rounded-top @error('sn') is-invalid @enderror" id="sn"
                    ...
                    <div class="form-floating">
                        <input type="text" name="merk" class="form-control @error('merk') is-invalid @enderror"
                            id="merk" placeholder="Merk" required value="{{ old('merk') }}">
                    ...
                    <div class="form-floating">
                        <input type="text" name="type" class="form-control @error('type') is-invalid @enderror"
                            id="type" placeholder="name@example.com" required value="{{ old('type') }}">
                    ...
                    <div class="form-floating">
                        <input type="text" name="owner"
                            ...
                            placeholder="owner" required value="{{ old('owner') }}">
                    ...
                    <div class="form-floating">
                        <input type="text" name="channel"
                            class="form-control rounded-bottom @error('channel') is-invalid @enderror" id="channel"
                            placeholder="channel" required value="{{ old('channel') }}">
